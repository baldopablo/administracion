Public Class FRM_FORMAS_DE_PAGO_BUSCAR_B_M
    ...
    Private Sub BTN_CLIE_BUS_EDITAR_Click(sender As System.Object, e As System.EventArgs) Handles BTN_CLIE_BUS_EDITAR.Click
        ...
        End If
        FRM_FORMAS_DE_PAGO.BTN_FDP_GUARDAR.Enabled = False
        FRM_FORMAS_DE_PAGO.BTN_FDP_ACTUALIZAR.Enabled = True
        FRM_FORMAS_DE_PAGO.Show()
    End Sub

    Private Sub BTN_CLIE_BUS_ELIMINAR_Click(sender As System.Object, e As System.EventArgs) Handles BTN_CLIE_BUS_ELIMINAR.Click
